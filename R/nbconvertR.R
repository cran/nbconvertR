...
.onLoad = function(libname, pkgname) {
  tools::vignetteEngine('nbconvert',
...
#tools::buildVignette('../../diffusion-map/vignettes/destiny.ipynb', encoding = 'UTF-8', engine = 'nbconvertR', buildPkg = 'nbconvertR')